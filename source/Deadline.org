...
+ You =MUST= ensure you have followed the guidelines carefully and you =are indeed confident= that you have =covered all key areas= for that section.
...
| section            | Date                |
|--------------------+---------------------|
| Analysis           | 20/09/16, Tuesday   |
| Documented Design  | 14/10/16, Friday    |
| Technical Solution | 16/12/16, Friday    |
| Test               | 13/01/17, Friday    |
| Evaluation         | 18/01/17, Wednesday |
